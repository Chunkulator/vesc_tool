...
#include "pageappserialrx.h"
#include "ui_pageappserialrx.h"
#include "utility.h"

PageAppSerialRx::PageAppSerialRx(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PageAppSerialRx)
{
    ui->setupUi(this);
...
PageAppSerialRx::~PageAppSerialRx()
{
    delete ui;
}

VescInterface *PageAppSerialRx::vesc() const
{
    return mVesc;
}

void PageAppSerialRx::setVesc(VescInterface *vesc)
{
    mVesc = vesc;
...
void PageAppSerialRx::reloadParams()
{
    if (mVesc) {
        ...
        ui->generalTab->addParamSubgroup(mVesc->appConfig(), "serialrx", "general");
...
void PageAppSerialRx::paramChangedDouble(QObject *src, QString name, double newParam)
{
    (void)src;
    (void)newParam;
...
void PageAppSerialRx::paramChangedEnum(QObject *src, QString name, int newParam)
{
    (void)src;
    (void)newParam;
